 ...
 * @author ERIK
 */
public class LaWeaQueNoSale extends javax.swing.JFrame {
   ...
   panelActividad.setLayout(new GridLayout(3, 5));
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(870, 380));
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaWeaQueNoSale.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LaWeaQueNoSale().setVisible(true);
            }
        });
    }
